 ...
 * </p>
 * <ul>
 *   <li>{@link graph.impl.GraphImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GraphImpl extends MinimalEObjectImpl.Container implements Graph {
	...
	public EList<GraphElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<GraphElement>(GraphElement.class, this, GraphPackage.GRAPH__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GraphPackage.GRAPH__ELEMENTS:
