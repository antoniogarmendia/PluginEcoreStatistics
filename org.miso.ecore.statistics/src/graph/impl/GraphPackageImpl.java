...
public class GraphPackageImpl extends EPackageImpl implements GraphPackage {
	 ...
	 * @generated
	 */
	public EAttribute getGraphRoot_Height() {
		return (EAttribute)graphRootEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getGraphRoot_AmountOfNodes() {
		return (EAttribute)graphRootEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getGraphElement_EClass() {
