 ...
 * @generated
 */
public class MetaModelGraphSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MetaModelGraphPackage.GRAPH: {
				Graph graph = (Graph)theEObject;
				T result = caseGraph(graph);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MetaModelGraphPackage.SUB_GRAPH: {
				SubGraph subGraph = (SubGraph)theEObject;
				T result = caseSubGraph(subGraph);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MetaModelGraphPackage.NODE: {
				Node node = (Node)theEObject;
				T result = caseNode(node);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MetaModelGraphPackage.RELATION: {
				Relation relation = (Relation)theEObject;
				T result = caseRelation(relation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MetaModelGraphPackage.COMPOSITION: {
			...
			case MetaModelGraphPackage.REFERENCE: {
			...
			case MetaModelGraphPackage.SUB_CLASS: {
				SubClass subClass = (SubClass)theEObject;
				T result = caseSubClass(subClass);
				if (result == null) result = caseRelation(subClass);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
